        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <hr/>
                  <a href="companyRegister.php">Click here for Company Registeration</a></br>
                  <a href="studentRegister.php">Click here for Student Registeration</a>
                </div>
                ...
                ?>
                    <form action="studentsave.php" method="post" enctype="multipart/form-data">
                        <table class="table">
                            ...
                            <tr>
                                <td>Enter DOB<br/><input type="date" id="dob" name="dob" class="form-control"/></td>
                            </tr>
                            <tr>
                                <td>Select Gender<br/>
