...
<body>
    <script type="text/javascript">
    <?php
    if(isset($_SESSION['csu']))
    {
        ?>
            alert("<?php echo $_SESSION['csu'];?>");
            <?php
        unset($_SESSION['csu']);
    }
    ?>
				...
				<div class="content">
					<div class="container-fluid">
						...
						<div class="row">
							...
							<div class="col-md-8">
								<div class="card">
                                                                    <form action="01ACompanyUpdateStatus.php" method="post">
                                                                        ...
                                                                        <table class="table">
                                                                            ...
                                                                            <tr>
                                                                                <td>Company</td>
                                                                                <td><input type="text" name="company" value="<?php echo $r['name'];?>" class="form-control" /></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Founded</td>
                                                                                <td><input type="text" name="founded" class="form-control" value="<?php echo $r['founded'];?>" onkeydown="CheckNum(this)"  onkeyup="CheckNum(this)"/></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Founder</td>
                                                                            ...
                                                                            <tr>
                                                                                <td>Services</td>
                                                                                <td><input type="text" name="services" value="<?php echo $r['services'];?>" class="form-control" required="required" onkeydown="Check(this)"  onkeyup="Check(this)"/></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Address</td>
